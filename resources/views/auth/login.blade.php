...
<div style="width: 100vw; height: 100vh;">
    ...
    <section class="bg-primary py-3 py-md-5 py-xl-8 position-relative" style="height: 100vh;">
                ...
                <div class="col-12 col-md-6 col-xl-7">
                    <div class="d-flex justify-content-center">
                        <div class="col-12 col-xl-12">
                            ...
                            <h2 class="h1 mb-4 text-white">Certificate en Nuestro  Centro Cientifico Nacional del Ozono</h2>
                            <p class="lead mb-5 text-white">"La Ozonoterapia del futuro es hoy."</p>
                            <div class="text-endx">
                ...
                <div class="col-12 col-md-6 col-xl-5">
                    <div class="card border-0 rounded-4 bg-white">
                        ...
                        <div class="text-center pt-3 px-4">
                            <img src="images/logoc.png" alt="Logo" class="img-fluid mx-auto d-block" style="max-height: 70px; width: auto; max-width: 60%;">
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <p class="mb-2">¿No tienes una cuenta? <a href="{{ $register_url}}">Registrate</a></p>
                                        </div>
                                    </div>
                                </div>
                                <!-- Rest of the form with reduced margins -->
