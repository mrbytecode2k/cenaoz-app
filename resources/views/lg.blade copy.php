          ...
          <div class="card border-0 rounded-4">
            <div class="card-body p-3 p-md-4 p-xl-5">
              <div class="row">
                <div class="col-12">
                  <div class="mb-4">
                    <h4>Autenticarse para iniciar sesión </h4>
              ...
              <form action="{{ $login_url }}" method="post">
                ...
                @enderror
                  ...
                  <div class="col-12">
                    <div class="form-floating mb-3">
                      <input type="password" class="form-control" @error('password') is-invalid @enderror name="password" id="password" value=""   placeholder="{{ __('adminlte::adminlte.password') }}" required>
...
<footer>
  ©2023 por CENAOZ. Fundación Centro Científico Nacional del Ozono. Rif: G-20016265-1
